                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="space-y-2 text-sm">
                                        <div class="flex items-center">
                                            <span class="text-gray-500 dark:text-gray-400 w-20">Latitude:</span>
                                            <span class="text-gray-700 dark:text-gray-300 font-mono">{{ complex.latitude }}</span>
                                        </div>
                                        <div class="flex items-center">
                                            <span class="text-gray-500 dark:text-gray-400 w-20">Longitude:</span>
                                            <span class="text-gray-700 dark:text-gray-300 font-mono">{{ complex.longitude }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
